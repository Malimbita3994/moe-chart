...
<div class="max-w-4xl mx-auto">
    ...
    <div class="animated-card card-hover bg-white rounded-xl shadow-lg p-6 mb-6 border-2 border-gray-300 animate-delay-100">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600">Update permission details and settings</p>
            </div>
        </div>
    </div>
    ...
    <div class="animated-card card-hover bg-white rounded-xl shadow-lg p-8 border-2 border-gray-300 animate-delay-200">
        <form action="{{ route('admin.users.permissions.update', $permission) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <div class="relative">
                        <select name="group" id="group"
                            ...
                            <option value="organization" {{ old('group', $permission->group) === 'organization' ? 'selected' : '' }}>Organization</option>
                            <option value="positions" {{ old('group', $permission->group) === 'positions' ? 'selected' : '' }}>Positions</option>
                            <option value="employees" {{ old('group', $permission->group) === 'employees' ? 'selected' : '' }}>Employees</option>
                            <option value="roles" {{ old('group', $permission->group) === 'roles' ? 'selected' : '' }}>Roles & Permissions</option>
                        </select>
