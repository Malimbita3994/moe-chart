    ...
    <div class="animated-card card-hover bg-white rounded-xl shadow-lg p-6 mb-6 border-2 border-gray-300 animate-delay-100">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600">Add a new user to the system and optionally assign them to a position</p>
            </div>
        </div>
    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="relative">
                            <select name="role_id" id="role_id"
                                ...
                                @foreach($roles ?? [] as $role)
                                    <option value="{{ $role->id }}" {{ old('role_id', $defaultRoleId ?? null) == $role->id ? 'selected' : '' }}>
                        ...
                        <p class="text-xs text-gray-500 mt-2 flex items-center">
                            ...
                            Each user should be assigned one system role to determine access and permissions.
                        </p>
                    </div>
                </div>
            ...
            <div class="border-t border-gray-300 pt-6 space-y-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-bold text-gray-800 flex items-center">
                        ...
                        Quick Position Assignment (Optional)
                    </h3>
                </div>
                ...
                <div class="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mb-4">
                    <p class="text-sm text-blue-800 flex items-start">
                        ...
                        <span>
                            <strong>Quick Assignment:</strong> You can assign a basic position here. After creating the user, you can edit their profile to add detailed assignment information (assignment type, authority reference, allowance, end dates, etc.).
                        </span>
                    </p>
                </div>
