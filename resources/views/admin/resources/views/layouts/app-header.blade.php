    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="{{ route('admin.dashboard') }}" class="xl:hidden">
                <img class="h-8 w-auto object-contain" src="{{ asset('image/logo.png') }}" alt="{{ config('app.name') }}" />
            </a>
            ...
            <div class="hidden xl:block">
                <form method="GET" action="{{ route('admin.search') }}">
                    <div class="relative">
                        ...
                        <input type="text" name="q" value="{{ request('q', '') }}" placeholder="Search or type command..."
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            <div class="flex items-center gap-2 2xsm:gap-3">
                ...
                @include('tailadmin::components.header.notification-dropdown')
            </div>

            <!-- User Dropdown -->
            @include('partials.admin.header-user-dropdown')
        </div>
    </div>
</header>
