...
@section('title', 'Create Advisory Body')
@section('page-title', 'Create Advisory Body')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="animated-card card-hover bg-white rounded-xl shadow-lg p-6 mb-6 border-2 border-gray-300 animate-delay-100">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Create New Advisory Body</h2>
                <p class="text-sm text-gray-600">Add a new advisory body or committee to the organization</p>
            </div>
        </div>
    </div>
    ...
    <div class="animated-card card-hover bg-white rounded-xl shadow-lg p-8 border-2 border-gray-300 animate-delay-200">
        <form action="{{ route('admin.advisory-bodies.store') }}" method="POST" class="space-y-6">
            @csrf
